...
class ADMassFractionNuclideDepletion : public ADIsotopeBase
{
public:
  static InputParameters validParams();

  ADMassFractionNuclideDepletion(const InputParameters & parameters);
...
}; // class ADMassFractionNuclideDepletion
