...
class ADSAAFExternalScattering : public ADSAAFBaseKernel
{
public:
  static InputParameters validParams();

  ADSAAFExternalScattering(const InputParameters & parameters);
...
protected:
   ...
   * _group_flux_moments[_qp][1] = Phi_{1, 1, -1}
   * _group_flux_moments[_qp][2] = Phi_{1, 1, 0}
   * _group_flux_moments[_qp][3] = Phi_{1, 1, 1}
   * _group_flux_moments[_qp][4] = Phi_{1, 1, 1}
   * _group_flux_moments[_qp][5] = Phi_{1, 2, -2}
   * _group_flux_moments[_qp][6] = Phi_{1, 2, -1}
   * _group_flux_moments[_qp][7] = Phi_{1, 2, 0}
   * _group_flux_moments[_qp][8] = Phi_{1, 2, 1}
   * _group_flux_moments[_qp][9] = Phi_{1, 2, 2}
   * _group_flux_moments[_qp][10] = Phi_{2, 0, 0}
   * _group_flux_moments[_qp][11] = Phi_{2, 1, -1}
   * _group_flux_moments[_qp][12] = Phi_{2, 1, 0}
   * _group_flux_moments[_qp][13] = Phi_{2, 1, 1}
   * _group_flux_moments[_qp][14] = Phi_{2, 1, 1}
   * _group_flux_moments[_qp][15] = Phi_{2, 2, -2}
   * _group_flux_moments[_qp][16] = Phi_{2, 2, -1}
   * _group_flux_moments[_qp][17] = Phi_{2, 2, 0}
   * _group_flux_moments[_qp][18] = Phi_{2, 2, 1}
   * _group_flux_moments[_qp][19] = Phi_{2, 2, 2}
   *
...
}; // class ADSAAFExternalScattering
