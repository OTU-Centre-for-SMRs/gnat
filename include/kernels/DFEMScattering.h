...
// scattering matrix is assembled and source iteration is avoided. This kernel should only
// be used for debugging purposes as a fully assembled scattering matrix solve for the transport
// equation is quite slow.
// TODO: Finish this kernel.
class DFEMScattering : public SNBaseKernel
{
public:
  static InputParameters validParams();

  DFEMScattering(const InputParameters & parameters);
