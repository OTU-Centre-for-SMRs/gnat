...
fuel_pin_or = openmc.ZCylinder(r = common.r_fuel)
fuel_gap_1_or = openmc.ZCylinder(r = common.r_fuel_gap)
fuel_zr_or = openmc.ZCylinder(r = common.r_fuel_clad)
fuel_bb = openmc.model.RectangularPrism(width = common.pitch, height = common.pitch)
...
tube_fill_or = openmc.ZCylinder(r = common.r_guide)
tube_clad_or = openmc.ZCylinder(r = common.r_guide_clad)
...
## The assembly.
assembly_bb = openmc.model.RectangularPrism(origin = (0.0, 0.0), width = 16.9 * common.pitch, height = 16.9 * common.pitch, boundary_type = 'reflective')
...
uo2_assembly.pitch = (common.pitch, common.pitch, common.fuel_height)
uo2_assembly.lower_left = (-17.0 * common.pitch / 2.0, -17.0 * common.pitch / 2.0, 0.0)
uo2_assembly.universes = [uo2_assembly_cells]

core_z_plane_center = openmc.ZPlane(z0 = 0.0, boundary_type = 'reflective')
core_z_plane_top    = openmc.ZPlane(z0 = common.fuel_height)
...
ref_assembly.pitch = (common.pitch, common.pitch)
ref_assembly.lower_left = (-17.0 * common.pitch / 2.0, -17.0 * common.pitch / 2.0)
ref_assembly.universes = ref_assembly_cells

refl_top = openmc.ZPlane(z0 = common.fuel_height + common.refl_height, boundary_type = 'vacuum')
...
c5g7_model.settings.source = [openmc.IndependentSource(space = openmc.stats.Box(lower_left = (-17.0 * common.pitch / 2.0, -17.0 * common.pitch / 2.0, 0.0),
                                                                                upper_right = (17.0 * common.pitch / 2.0, 17.0  * common.pitch / 2.0, common.fuel_height)))]
