...
ADSNBaseBC::ADSNBaseBC(const InputParameters & parameters)
  : ADIntegratedBC(parameters), _aq(getUserObject<AQProvider>("aq")), _symmetry_factor(1.0)
{
...
void
ADSNBaseBC::cartesianToSpherical(const RealVectorValue & ordinate, Real & mu, Real & omega)
{
  mu = 0.0;
  omega = 0.0;
