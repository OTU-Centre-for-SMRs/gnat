...
ADNeutronBaseBC::ADNeutronBaseBC(const InputParameters & parameters)
...
void
ADNeutronBaseBC::cartesianToSpherical(const RealVectorValue & ordinate,
                                      Real & mu, Real & omega)
{
