#include "ADSAAFNuclideDecaySource.h"

registerMooseObject("GnatApp", ADSAAFNuclideDecaySource);

InputParameters
ADSAAFNuclideDecaySource::validParams()
{
...
ADSAAFNuclideDecaySource::ADSAAFNuclideDecaySource(const InputParameters & parameters)
  : ADSAAFBaseKernel(parameters), _decay_consts(getParam<std::vector<Real>>("decay_constants"))
{
