#include "ADDFEMExternalScattering.h"

#include "RealSphericalHarmonics.h"

registerMooseObject("GnatApp", ADDFEMExternalScattering);

InputParameters
ADDFEMExternalScattering::validParams()
{
...
ADReal
ADDFEMExternalScattering::computeQpResidual()
{
