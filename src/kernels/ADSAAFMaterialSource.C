#include "ADSAAFMaterialSource.h"

#include "RealSphericalHarmonics.h"

registerMooseObject("GnatApp", ADSAAFMaterialSource);

InputParameters
ADSAAFMaterialSource::validParams()
{
...
ADSAAFMaterialSource::ADSAAFMaterialSource(const InputParameters & parameters)
...
ADReal
ADSAAFMaterialSource::computeQpResidual()
{
