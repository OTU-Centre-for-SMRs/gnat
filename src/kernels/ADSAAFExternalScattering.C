#include "ADSAAFExternalScattering.h"

#include "RealSphericalHarmonics.h"

registerMooseObject("GnatApp", ADSAAFExternalScattering);

InputParameters
ADSAAFExternalScattering::validParams()
{
...
ADReal
ADSAAFExternalScattering::computeQpResidual()
{
