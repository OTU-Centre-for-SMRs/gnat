#include "ADFVMassFractionNuclideDepletion.h"

registerMooseObject("GnatApp", ADFVMassFractionNuclideDepletion);

InputParameters
ADFVMassFractionNuclideDepletion::validParams()
{
...
ADFVMassFractionNuclideDepletion::ADFVMassFractionNuclideDepletion(
...
ADReal
ADFVMassFractionNuclideDepletion::computeQpResidual()
{
  ...
  return res * _u_functor(elem_args, 0u) * _density(elem_args, 0u);
}
