#include "ADFVNuclideInflowBC.h"

registerMooseObject("GnatApp", ADFVNuclideInflowBC);

InputParameters
ADFVNuclideInflowBC::validParams()
{
...
ADFVNuclideInflowBC::ADFVNuclideInflowBC(const InputParameters & parameters)
  : FVFluxBC(parameters),
...
ADReal
ADFVNuclideInflowBC::computeQpResidual()
{
  ...
  return _normal * vel * _inflow_rate;
}
